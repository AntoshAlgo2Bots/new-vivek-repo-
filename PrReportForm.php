...
$sql = "SELECT * FROM for_office.requisition_header_level a INNER JOIN for_office.requisition_line_level b ON a.header_id=b.requisition_id";
...
WHERE a.header_id ='$query' or a.department_name ='$query' ";
...
<head>
    ...
    <title>Cretion Requisition Report</title>
</head>
